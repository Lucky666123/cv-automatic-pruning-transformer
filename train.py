...
def save_model(args, model, stream_id):
    ...
    model_checkpoint = os.path.join(args.output_dir, str(stream_id)+"_%s_checkpoint.bin" % args.name)
...
def train(args, model, clip_layer_id):
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if global_step % args.eval_every == 0 and args.local_rank in [-1, 0]:
                    ...
                    accuracy = valid(args, model, writer, test_loader, global_step, stream_id=1,
                                     clip_layer_id=clip_layer_id)
    ...
    logger.info("Best Clip Accuracy: \t%f" % best_clip_acc)
